...
namespace Game.NomadWorkshop.Foundation
{
    ...
    public readonly struct FoundationReadModel
    {
        ...
        public readonly ReadOnlyReactiveProperty<int> WaterCanWater;
        ...
        public readonly ReadOnlyReactiveProperty<int> VehicleWater;
        public readonly ReadOnlyReactiveProperty<int> DrinkingStationWater;
        public readonly ReadOnlyReactiveProperty<int> BodyWater;
        public readonly ReadOnlyReactiveProperty<int> BladderWaste;
        public readonly ReadOnlyReactiveProperty<int> ToiletHoldingWaste;
        ...
        public FoundationReadModel(NomadFoundationModel model)
        {
            ...
            WaterCanWater = model.WaterCanWater;
            LatestActionPlan = model.LatestActionPlan;
            ResidentThirst = model.ResidentThirst;
            ResidentRecreation = model.ResidentRecreation;
            VehicleWater = model.VehicleWater;
            DrinkingStationWater = model.DrinkingStationWater;
            BodyWater = model.BodyWater;
            BladderWaste = model.BladderWaste;
            ToiletHoldingWaste = model.ToiletHoldingWaste;
